                    ...
                    "messages": [{
                        ...
                        "content": [
                            ...
                            },
                            {
                                ...
                                "For engineProgram: look for engine maintenance program enrollment on the ENGINES "
                                "specifically (not APU, not airframe/avionics programs like ProParts). "
                                "Return the exact program name as listed on the sheet (whatever spacing/wording the "
                                "sheet itself uses — do not normalize it), or null if not found. This field is for "
                                "display only; do not use it for pricing — that's what engineProgramTier is for. "
                                "For engineProgramTier: classify the SAME engine program into exactly one of these "
                                "canonical tiers, based on the engine family (visible from make/model — PW500 family "
                                "covers Citation Excel/XLS/XLS+/XLS Gen2; HTF7000 covers Challenger 300/350/3500; "
                                "BR710 covers G450/G550/G650 and other large Gulfstreams):\n"
                                "  \"premium\" — top OEM tier: PW500 Power Advantage Plus/PA+/ESP Gold/ESP-G; "
                                "HTF7000 MSP Gold/MSP-G/CMSP Gold; BR710 CorporateCare Enhanced/RRCC Enhanced/RRCC-E.\n"
                                "  \"baseline\" — standard OEM tier: PW500 Power Advantage/ESP (not Plus/Gold); "
                                "HTF7000 MSP/CMSP (not Gold); BR710 CorporateCare/RRCC (not Enhanced).\n"
                                "  \"smartparts\" — Bombardier's own alternative to Honeywell MSP (Smart Parts Plus, "
                                "Dependability Plus). Only applies to HTF7000/Challenger aircraft.\n"
                                "  \"independent\" — third-party/multi-make coverage, not OEM-specific: JSSI (any "
                                "variant), Engine Assurance Program/EAP, N1 Smart Engine/AvGuard, Vector VMAX, "
                                "Aerodynamics SA, Propulsion International, eJet Services.\n"
                                "  \"off_program\" — explicitly not enrolled in any engine program.\n"
                                "  \"unknown\" — engine program field not found on the sheet, or enrollment is "
                                "mentioned but the specific program/tier isn't identifiable from the text.\n"
                                "Use null for any other field not found. No markdown, no explanation, just JSON."
                                )
                            }
                        ]
                    }]
